...
" Functions {
    ...
    function! s:IsSpf13Fork()
        let s:is_fork = 0
        let s:fork_files = ["~/.config/nvim/fork.vim", "~/.config/nvim/before.fork.vim", "~/.config/nvim/bundles.fork.vim"]
    ...
    function! s:EditSpf13Config()
        ...
        if <SID>IsSpf13Fork()
            ...
            wincmd l
            call <SID>ExpandFilenameAndExecute("split", "~/.config/nvim/bundles.fork.vim")
        endif
